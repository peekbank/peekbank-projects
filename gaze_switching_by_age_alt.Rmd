...
Summary: No developmental change in pre-critical event switches, but a decrease
in switches during the post-critical event parts of the trial 
...
Number of switches by stimulus familiarity
Summary: 
There are fewer switches for familiar (compared to novel) stimuli:
...
Duration of fixations by age
Summary: 
The duration of fixations increases with age for all stages of the trial, but especially the last half of the post-critical event
