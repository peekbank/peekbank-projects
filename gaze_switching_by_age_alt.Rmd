...
# TO-DO: Ask Martin about sampling frequency and if we're using the correct onset and offset
...
>>>>>>> Stashed changes
  mutate(
    ...
    t_start = min_tnorm+cumulative_length_start*25, # ask Martin
    t_end = min_tnorm+(cumulative_length_end-1)*25,# ask Martin
